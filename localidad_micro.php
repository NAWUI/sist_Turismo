                                ...
                                if ($row_evaluador) {
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">Tiutulo: <?php echo $titulo; ?></label>
                                        </div>  
                                        <div class="form-check">  
                                            <label class="form-check-label">Descripcion: <?php echo $descripcion; ?></label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label">Calificacion: <?php echo $calificacion; ?></label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label">Evaluador: <?php echo $evaluador; ?></label>
                                        </div>
                                    </div>
                                    <?php
                                } else {
